...
const {generateAndInsertGxRealToday, generateAndInsertGxReal,
    realGenerationJobToday, realGenerationJob} = require('./cronjobs/real-generation.job');
const {forecastDemandJob, generateAndInsertDemandForecast} = require('./cronjobs/forecast-demand.job');
const {generateAndInsertDemandaReal, generateAndInsertDemandRealToday,
    realDemandJob, realDemandJobToday} = require('./cronjobs/real-demand.job');
